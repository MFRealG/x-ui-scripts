...
```sh
bash <(curl -sSL https://raw.githubusercontent.com/MFRealG/x-ui-scripts/main/build_3x-ui.sh)
```

## Install [Warp](https://gitlab.com/fscarmen/warp) (on socks5 proxy) for 3x-ui

```sh
bash <(curl -sSL https://raw.githubusercontent.com/MFRealG/x-ui-scripts/main/install_warp_proxy.sh)
```
